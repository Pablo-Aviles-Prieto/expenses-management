...
export const CustomPopover: FC<PropsI> = ({ buttonValue }) => {
  return (
        ...
        <>
          <Popover.Button
            className={`
                ...
                group inline-flex items-center rounded-md bg-indigo-600 px-3 py-2 text-slate-200 font-bold 
								text-base hover:text-opacity-100 focus:outline-none focus-visible:ring-2 
								focus-visible:ring-indigo-400 focus-visible:ring-opacity-75 hover:bg-indigo-700`}
          >
